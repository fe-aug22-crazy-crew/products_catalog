      ...
      <article className="info__article">
        ...
        <div className="info__paragraph">
          ...
          <p className="info__text">
            ...
            upto four times more scene. Get beautiful images in
            drastically lower light. Shoot the highest‑quality video in a
            smartphone — then edit with the same tools you love for
        ...
        <div className="info__paragraph">
          ...
          <p className="info__text">
            ...
            processing power means it can shoot 4K video with extende
