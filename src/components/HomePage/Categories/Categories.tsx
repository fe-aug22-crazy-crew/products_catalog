    ...
    <section className="categories">
      ...
      <div className="categories__main">
        <div className="categories__category">
          <NavLink to={'/phones'} className="categories__image-block">
        ...
        <div className="categories__category">
          <NavLink to={'/tablets'} className="categories__image-block">
        ...
        <div className="categories__category">
          <NavLink to={'/accessories'} className="categories__image-block">
            <img
              src={Accessories}
              alt="category"
