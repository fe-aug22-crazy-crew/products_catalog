  ...
  return (
    <div className='product'>
      <img 
        ...
        src={'https://raw.githubusercontent.com/mate-academy/product_catalog/main/public/img/phones/apple-iphone-xr/coral/00.jpg'} 
        alt="phone"
      />
